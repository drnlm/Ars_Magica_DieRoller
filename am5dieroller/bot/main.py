...
from am5dieroller.ars_magica_rolls.spont_rolls import spont_roll, fatiguing_spont_roll
...
async def formulaic(interaction: discord.Interaction, casting_score: int, target: int):
     await interaction.response.send_message(f"Called with {casting_score} and {target}")
